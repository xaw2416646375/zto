...
public class UserIDBase64 {
	...
	public static void main(String[] args) {
		...
		System.out.println(encoderUserID(123456));
		System.out.println(decoderUserID("#AjM0gjN##wNxUDM3gDO0gjNxYTM"));
		System.out.println(decoderUserID("#AjMzgjM##QN1AjN4gTOzgjM3UTM"));
		System.out.println(decoderUserID("%23ATM0gjN%23%23gM4IjM4YDO0gjNxYTM"));
	}
}