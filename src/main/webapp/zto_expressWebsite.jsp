...
<html lang="en"><head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://www.zto.com/imgs/logo.ico" media="screen"><link type="text/css" rel="stylesheet" href="../../../../../Desktop/服务网点%20-%20中通快递_files/skin.css">
    ...
    <div class="header-main">
        ...
        <div class="header-middle">
            <ul>
                ...
                <li class="business">
                    <span>物流业务</span>
                    <div class="business-menu clearboth international-add-new" style="display: none;">
                ...
                <li>
                    ...
                    <div class="business-menu clearboth" style="display: none;">
                ...
                <li>
                    <span>关于中通</span>
                    <div class="business-menu clearboth index-6" style="display: none;">
                ...
                <li>
                    <span>投资者关系</span>
                    <div class="business-menu clearboth index-7" style="display: none;">
        ...
        <div class="header-right">
            ...
            <div class="login">
                <img src="js_01/login.png" alt="登录"> 登录
            </div>
            <div class="registere">
                <img src="js_01/register.png" alt="注册"> 注册
            </div>
            <div class="backold">
                    ...
                    <div class="website-nearby">
                        ...
                        <h3 class="area-title">${count}个网点</h3>
                            <c:forEach var="list" items="${branchList}">
                                <br/>
                                <div  style="padding: 5px" id="backgroundhover" class="${list.branch_id}id" style="cursor:Pointer">
                                    <table>
                                        <tr>
                                            <td></td><td style="height: 25px;font-size: 15px">${list.branch_address}</td>
                                        </tr>
                                        <tr>
                                            <td></td><td style="height: 25px;color: darkgrey">${list.branch_phone}</td>
                                        </tr>
                                    </table>
                                </div>
                                <hr/>
                                          ...
                                          <div class="message-box show">
                                              ...
                                              <div class="website-imgbox">
                                                  <div class="website-img">
                                                      <img src="../imgs/express/website1.jpg" />
                                                  </div>
                                              </div>
                                          </div>
