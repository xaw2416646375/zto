...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['src/main/webapp/static/js/jquery', 'ChineseDistricts'], factory);
    } else if (typeof exports === 'object') {
        // Node / CommonJS
        factory(require('src/main/webapp/static/js/jquery'), require('ChineseDistricts'));
    } else {
        // Browser globals.
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:8%; width:82px ">' +
